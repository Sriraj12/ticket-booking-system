        ...
        <header className="border-b border-slate-800/70 bg-slate-950/95 px-6 py-4 shadow-xl backdrop-blur-xl">
            <div className="flex items-center justify-between gap-4">
                ...
                <div className="flex items-center gap-3">
                    <button onClick={openLocationModal} className="rounded-2xl border border-slate-700 bg-slate-900/90 px-4 py-2 text-sm font-medium text-white hover:bg-slate-800 transition">
                    ...
                    <div className="text-right">
                        <p className="font-medium text-white">Parvathi</p>
                        <p className="text-sm text-slate-400">testseller@gmail.com</p>
                    </div>
                </div>
            </div>
                    ...
                    <div className="w-full max-w-2xl rounded-3xl border border-slate-700/80 bg-slate-950/95 p-8 shadow-2xl">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="mt-1 text-slate-400">Choose the city where you run shows.</p>
                            </div>
